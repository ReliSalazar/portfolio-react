const posts = [
  {
    ...
    editDate: "",
    author: "Reli",
    img: "/BlogImages/about/selfie-1.webp",
    body: [
      {
        contentType: "paragraph",
        content:
          "Hello, I'm Reli Salazar and I am from Mexico.\nSince I can remember, I have always had a great afinity for computers, even my mother often tells me that I wanted to create robots and she talked about it all the time.",
      },
      {
        contentType: "paragraph",
        content:
          "My first contact with software development was more or less in 2014, I tried to do a video game programming course with Unity using monodevelop and C#, but honestly it was too difficult, today I know that it is one of the most complex areas in the software development, but the good side is that the experience only gave me determination to start something simpler.",
      },
      {
        contentType: "paragraph",
        content:
          "shortly after I started learning C++ with the book <a href='https://www.amazon.com/Primer-5th-Stanley-B-Lippman/dp/0321714113' target='_blank' rel='noopener noreferrer'>C++ Primer Fifth Edition</a>. What I like most about software development is the feeling of creating things from nothing, it is almost magical, you write a spell and something appears that a few hours ago did not exist and with which you can interact, and above all, it solves a problem.",
      },
      {
        contentType: "note",
        content:
          "This isn't actually the first book I read about programming, but it's the most important for me.",
      },
      {
        contentType: "paragraph",
        content:
          "Over time I also learned other technologies such as Python, GoLang, C#, HTML, JS, React, Vue, TypeScript, PHP and Laravel. Although I have also tried other things such as video game development with the GML or Python using Godot, or development for Arduino with C.",
      },
    ],
  },
  {
    id: "idea-oriented-programming",
    title: "Idea Oriented Programming",
    date: "April 29, 2020",
    editDate: "",
    author: "Reli",
    header: "/BlogImages/idea-oriented-programming/header-1.webp",
    img: "/BlogImages/idea-oriented-programming/header-1.webp",
    body: [
      {
        contentType: "paragraph",
        content:
          "About three years ago, when I saw object-oriented programming for the first time, I realized a curious thing, and it is that it has a great resemblance to Plato's Theory of Ideas, at the time Imade a couple of jokes with that and in part, it helped me understand the concept better, but a few days ago I revisited this idea and began to reflect on the subject, so I write this post so that those reflections do not remain only in my head.\nBut first I would like to give an explanation about what exactly Plato's Theory of Ideas was. Broadly speaking, we could explain it as a series of three dualisms to explain reality.",
      },
      {
        contentType: "note",
        content:
      ...
      },
      {
        ...
        content: "Ontological dualism",
      },
      {
        contentType: "paragraph",
        content:
          "The first dualism is the ontological one, that is, of reality; which consists of dividing reality into two worlds, on one hand the sensible world and on the other one the intelligible world.\nIn the sensible world, there are sensible things, that is, all those that are subject to change, while in the intelligible wolrd, it is where the ideas or forms or subsisting essences of things exists.",
      },
      {
        contentType: "paragraph",
        content:
      ...
      },
      {
        contentType: "paragraph",
        content:
          'Plato was highly influenced by Socrates when thinking about this idea, as you surely know, Socrates was a man who went around asking people the definition of things, what is love? what is justice?\nSocrates\' activity then consists in asking about the essence, the "what" of something. Being the essence what remains below the changes or the possible multiplicity.',
      },
      {
        contentType: "paragraph",
        content:
      ...
      {
        contentType: "subtitle",
        content: "Epistemological dualism",
      },
      {
        contentType: "paragraph",
        content:
      ...
      {
        contentType: "subtitle",
        content: "Anthropological dualism",
      },
      {
        contentType: "paragraph",
        content:
          "The body corresponds to the sensible world and the senses, while the soul corresponds to the world of ideas and reason. But in this dualism, the relationship between the two extremes is more conflictive. The body is here, in Plato's words, the prison of the soul <span>[Phaedo, 82e]</span>. And the soul yearns above all to free itself from the body and return to the world of ideas to directly contemplate the object of its desire.",
      },
      {
        contentType: "paragraph",
        content:
      ...
      },
      {
        contentType: "paragraph",
        content:
          "This is transferred above all to the position between body and soul, in fact many Christian philosophers take up this idea to talk about the relationship between God and humans, in addition to their idea of the soul.\nIdeas are so much more real than things, that if there were no ideas, there would be no things as we know and understand them. Ideas are the foundation, the base, the condition of possibillity of things, that things are what they are and that we can know them, because if there were nothing stable or permanent in change, we couldn't know.\nIdeas are the true reality, everything that is real in things, they owe to ideas.",
      },
      {
        contentType: "note",
        content:
      ...
      {
        contentType: "subtitle",
        content: "How are things and ideas related",
      },
      {
        contentType: "paragraph",
        content: "Plato explains the relationship with three metaphors:",
      },
      {
        contentType: "paragraph",
        content:
          "<span>The Participation (méthexis):</span> From bottom to top, from the thing to the idea: The thing participates in the idea, the thing aspires to the idea, tries to resemble or exemplify it, as if it were oriented to the idea and wanted to achieve its perfection, the idea is its model and the thing tries to imitate it.",
      },
      {
        contentType: "paragraph",
        content:
          "<span>The Presence (parousía):</span> From top to bottom, from the idea to the thing: the idea becomes present in the thing, the idea manifests itself in the sensible world through the thing.",
      },
      {
        contentType: "paragraph",
        content:
          "<span>The Community (koinonía):</span> Double direction: There is a certain communion or community between the thing and the idea, this is explained by the double relationship seen before.",
      },
      {
        contentType: "paragraph",
        content:
      ...
      {
        contentType: "note",
        content: "(huh... Sorry for that cringy part, that was 2 years ago...)",
      },
      {
        contentType: "paragraph",
        content:
